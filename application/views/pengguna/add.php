...
<form class="form-horizontal" action="tambah_aksi" method="post" enctype="multipart/form-data" autocomplete="off">
              ...
              <fieldset class="content-group">
               ...
               <br>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="nip" class="form-control" value="" placeholder="Nip" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label" for="birthday">Tanggal Lahir <span class="required">*</span>
                    </label>
                    <div class="col-sm-3">
                     <!--  <input type="date" name="tgl_lahir" class="form-control" value="" placeholder="Tgl Lahir" maxlength="100" required> -->
                      <input id="birthday" name="birthday" class="form-control" required="required" type="text" placeholder="Enter......">
                    </div>
                  </div>

                   <div class="form-group">
                      <label class="col-sm-3 control-label" for="usia">Usia <span class="required">*</span>
                      </label>
                      <div class="col-sm-4">
