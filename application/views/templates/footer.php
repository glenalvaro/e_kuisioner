...
<script src="<?php echo base_url()?>assets/gantella/js/moment/moment.min.js"></script>
 <script type="text/javascript">
            $(document).ready(function() {
              $('#tanggal_survei').daterangepicker({
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          $("#cari").click(function(){
            var tanggal_survei = $("#tanggal_survei").val();
            if(tanggal_survei == ""){
            ...
            $.ajax({
              type : "get",
              url  : "<?php echo base_url('respon/search')?>",
              data : "tanggal="+tanggal_survei,
