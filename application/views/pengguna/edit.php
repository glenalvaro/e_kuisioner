      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box box-danger">
            ...
            <div class="box-body">
              <center><img src="<?php echo base_url ($e->image); ?>" width="190" height="170" value="<?php echo $e->image; ?>">
              </center>
              <br>  
              <center>
              ...
              <fieldset class="content-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" name="nip" class="form-control" value="<?php echo $e->nip ?>">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label" for="birthday">Tanggal Lahir <span>*</span>
                    </label>
                    <div class="col-sm-3">
                      <!-- <input type="date" name="tgl_lahir" class="form-control" value="<?php echo $e->tgl_lahir ?>" placeholder="Tempat Tgl Lahir" maxlength="100" required> -->
                       <input id="birthday" name="birthday" class="form-control" type="text" placeholder="Enter...">
                    </div>
                  </div>

                  <div class="form-group">
                      <label class="col-sm-3 control-label" for="usia">Usia <span>*</span>
                      </label>
                      <div class="col-sm-4">
                        <input id="usia" name="usia" class="form-control" type="text" placeholder="Enter....." value="<?php echo $e->usia ?>" readonly>
                      </div>
                    </div>
